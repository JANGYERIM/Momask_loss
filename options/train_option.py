...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--teacher_train_text_dir', type=str, default=None, help='Teacher caption directory for train split')
        self.parser.add_argument('--teacher_val_text_dir', type=str, default=None, help='Teacher caption directory for val split')
