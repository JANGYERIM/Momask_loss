...
class MaskTransformer(nn.Module):
    ...
    def _sample_mask(self, ids, m_lens):
        ...
        # [1 2 3 4 5 512 512 512]
        # [2 4 3 1 512 512 512 512]
        # [3 1 2 4 5 1 7 8 1] 이런식으로 됨
        ...
        #mask 는 bool 값, True인 위치가 모델이 맞추어야하는 마스크 위치
        mask &= non_pad_mask
        # 패딩 위치가 아닌지 한번 더 거름
    ...
    def forward(self, ids, y, m_lens, teacher_y=None):
        '''
        :param ids: (b, n) -> b: 배치사이즈, n: t//4 이고 각 값은 토큰 인덱스
