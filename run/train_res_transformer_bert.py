...
from models.mask_transformer.transformer_bert import ResidualTransformer
from models.mask_transformer.transformer_trainer_bert import ResidualTransformerTrainer
...
if __name__ == '__main__':
    ...
    clip_version = 'bert-base-uncased'
