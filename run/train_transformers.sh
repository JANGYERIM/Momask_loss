...
/data/dpfla3573/anaconda3/envs/momask/bin/python run/train_t2m_transformer_bert.py \
  --name mtrans_v5-1 \
  --gpu_id 0 \
  --dataset_name t2m \
  --batch_size 64 \
...
/data/dpfla3573/anaconda3/envs/momask/bin/python run/train_res_transformer_bert.py \
  --name rtrans_v5-1 \
  --gpu_id 1 \
  --dataset_name t2m \
  --batch_size 64 \
